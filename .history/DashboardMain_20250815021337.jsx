      ...
      <section className="flex flex-wrap gap-6">
        <div className="top-courses-card  rounded-[12px] shadow-[0_4px_12px_rgba(0,0,0,0.1)] p-[25px]">
          <div className="flex justify-between items-center mb-5 pb-2 border-b border-zinc-400">
            ...
            <select
              className="px-3 py-2 rounded-lg border text-zinc-800   text-sm cursor-pointer focus:border-4 focus:ring-2 focus:ring-[rgba(106,98,255,0.2)] outline-none "
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm text-gray-800  ">
          <div className="flex justify-between items-center mb-5 pb-2 border-b border-[var(--border-color)]">
            ...
            <select
              className="px-3 py-2 rounded-lg border-0 border-zinc-400 bg-zinc-400 text-zinc-700 focus:ring-2 focus:ring-[rgba(106,98,255,0.2)] outline-none"
