  ...
  return (
    <main className="flex-grow p-5 flex flex-col gap-6">
      ...
      <section className="flex flex-wrap gap-6">
        <div className="top-courses-card bg-[var(--card-background)] rounded-[12px] shadow-[0_4px_12px_rgba(0,0,0,0.1)] p-[25px]">
          <div className="flex justify-between items-center mb-5 pb-2 border-b border-[var(--border-color)]">
            <h3 className="text-[1.2rem] font-semibold text-[var(--text-color)]">
              Top Courses
            </h3>
            <select
              className="px-3 py-2 rounded-lg border border-[var(--border-color)] bg-[var(--background-light)] text-[var(--text-color)] text-sm cursor-pointer focus:border-[var(--primary-color)] focus:ring-2 focus:ring-[rgba(106,98,255,0.2)] outline-none "
          ...
          <ul className="list-none p-0">
            <li
              className="flex justify-between items-center py-3 border-b border-[var(--border-color)] cursor-pointer hover:bg-[var(--background-light)] hover:rounded-md transition-colors"
              onClick={() =>
