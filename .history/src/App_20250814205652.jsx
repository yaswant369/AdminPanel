      ...
      >
        {isSidebarOpen && (
          ...
          >
            ...
            <nav className="w-[100%] gap-[5vh] flex flex-col justify-center items-center">
              <div className="navIcons   max-w-[90%] flex justify-evenly items-center p-[0px 2.5vw]">
                <svg
                  className="w-[3vw]"
                  width="20"
                  height="20"
        ...
        >
          ...
          <section id="students" className="panel slide-in">
            ...
            <div className="Searching  flex justify-center items-center mb-[30px] w-[100%] bg-amber-300 relative">
              <svg
                width="20"
                height="20"
                viewBox="0 0 24 24"
              ...
              <input
                ...
                placeholder="Search"
                className="placeholder:pl-[3vw] focus:outline-none w-[90%] focus:ring-2 focus:ring-blue-500 search-input border-[#D1D5DB] border-2 rounded-[6px] text-[#6B7280] p-[12px]"
              />
            </div>
