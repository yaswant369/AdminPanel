        ...
        {isSidebarOpen && (
          ...
          >
            ...
            <nav className="w-[100%] gap-[5vh] flex flex-col justify-center items-center">
              <div className="navIcons   max-w-[90%] flex justify-between items-center p-[0px 2.5vw]">
                <svg
                  className="w-[3vw]"
                  width="20"
                  height="20"
                ...
                <a
                  href="#dashboard"
                  className={` flex justify-center  rounded-lg items-center text-white p-[12px 7px]  ${
