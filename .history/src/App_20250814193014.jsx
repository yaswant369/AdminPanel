        ...
        {isSidebarOpen && (
          ...
          >
            ...
            <nav className="w-[100%] gap-[5vh] flex flex-col justify-center items-center">
              <div className="navIcons  bg-amber-200 max-w-[80%] flex justify-evenly items-center p-[0px 2.5vw]">
                <svg
                  className="w-[3vw]"
                  width="20"
                  height="20"
              ...
              <div className="navIcons flex justify-around items-center p-[0px 2.5vw]">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 24 24"
