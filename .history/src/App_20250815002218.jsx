        ...
        >
          ...
          <section id="companies" className="panel slide-in">
            ...
            <div className="add-item-form ">
              ...
              <button
                onClick={addCompany}
                className=" bg-[#00aaff] text-white px-0 py-0 rounded-lg cursor-pointer text-base font-medium border-0 transition duration-200 ease-in-out hover:bg-[#016ca2] hover:-translate-y-[2px]"
              >
                Add Company
              </button>
            </div>
