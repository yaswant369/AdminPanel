    ...
    <div>
      ...
      >
        ...
        >
          ...
          <section
            id="students"
            className="bg-white p-[30px] mb-[30px] rounded-xl shadow-[var(--shadow)] relative slide-in"
          >
          ...
          >
            ...
            <div className="grid   [grid-template-columns:repeat(auto-fill,minmax(280px,1fr))] gap-[25px]">
              {companies.map((company) => (
                <div
                  key={company.id}
                  className={`bg-white border-l-4 border-[var(--error)] p-6 shadow-md hover:shadow-lg transition-all duration-300 ease-in-out transform hover:-translate-y-1 flex  flex-col justify-between ${company.status} fade-in`}
                >
                  <h3 className="mb-3 text-[1.3rem] text-gray-900 font-semibold">
                    {company.name}
                  </h3>
                  ...
                  <div className="flex flex-wrap  gap-5">
                    <button
                      ...
                      className="border-l-4 border-[#00bda5] text-white px-6 py-2 rounded-md mr-0 bg-[#00bda5]"
                    >
                      Approve
                    </button>
                    <button
                      ...
                      className="text-white px-6 py-2 border-l-4 border-[var(--error)] rounded-md mr-0 bg-[#e74c3c]"
                    >
                      Reject
                    </button>
                  </div>
