          ...
          >
            ...
            <nav className="w-[100%] gap-[5vh] flex flex-col justify-center items-center">
              <div className="gap-6 justify-between max-w-[90%] flex items-center p-[0px 2.5vw]">
                ...
                <a
                  href="#dashboard"
                  className={`hover:bg-slate-700 hover:translate-x-[5px] transition duration-200 flex justify-center  rounded-lg items-center text-white p-[12px ]  ${
              ...
              <div className="gap-6 justify-between max-w-[90%] flex  items-center p-[0px 2.5vw]">
                ...
                <a
                  href="#mentor"
                  className={`hover:bg-slate-700 hover:translate-x-[5px] transition duration-200 flex items-center  text-wrap justify-center  rounded-lg text-white py-[12px] px-[5px]
