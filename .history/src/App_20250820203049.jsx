...
function App() {
  ...
  return (
    <div className="overflow-x-hidden min-h-screen bg-gray-50">
      <header className="fixed top-0 left-0 right-0 z-50 w-full flex h-full items-center px-4 py-3 bg-white shadow-md">
        {isMobile && (
          <button
      ...
      <div className="flex pt-16 relative min-h-screen ">
        {/* Sidebar */}
        <aside
          className={`sidebar left-0 top-0 fixed md:static z-40 bg-gray-800 text-white h-screen md:h-[calc(100vh-4rem)] transition-all duration-300 ease-in-out ${
            isSidebarOpen
              ? "left-0 w-64"
