...
function App() {
  ...
  return (
    <div>
      <header className="mb-[30px] fixed top-0 left-0 z-[9] w-screen text-center px-[30px] py-[20px] rounded-xl shadow-[var(--shadow)] bg-white">
        {!isSidebarOpen && (
          <div
        ...
        <h1 className=" w-[] text-[2rem] flex items-center gap-[10px]">
