...
function App() {
  ...
  return (
    <div className=" overflow-x-hidden">
      <header className="mb-[30px] fixed top-0 left-0 z-[9] w-screen overflow-x-hidden flex items-center text-center px-[30px] py-[20px] rounded-xl shadow-zinc-600 bg-white">
        {isMobile && !isSidebarOpen && (
          <div
            className="text-[2rem] cursor-pointer text-black z-[1001]"
        ...
        <h1 className="text-[2rem] flex items-center gap-[10px] ml-4">
      ...
      >
        {isSidebarOpen && (
          <aside
            ...
            className={`sidebar  z-10 bg-[#1e293b] h-[80vh] text-white p-[20px] fixed top-[55%] -translate-y-1/2 shadow-md shadow-[rgba(0, 0, 0, 0.1)]  ${
              isSidebarOpen ? " max-w-[250px]" : "closed"
            }  `}
          >
            <img
            ...
            <nav className="w-[100%] gap-[5vh] flex flex-col justify-center items-center">
              <div className="gap-6 justify-between max-w-[90%] flex items-center p-[0px 2.5vw]">
                <svg
                  className="w-[3vw]"
                  width="20"
                  height="20"
                ...
                <a
                  href="#dashboard"
                  className={`hover:bg-slate-700 hover:translate-x-[5px] transition duration-200 flex justify-center  rounded-lg items-center text-white  py-[12px] px-[5px]  ${
              ...
              <div className=" gap-6 max-w-[90%] flex justify-between  items-center ">
                <svg
                  className="w-[3vw]"
                  width="20"
                  height="20"
              ...
              <div className="gap-6 justify-between max-w-[90%] flex  items-center p-[0px 2.5vw]">
                ...
                <a
                  href="#companies"
                  className={`hover:bg-slate-700 hover:translate-x-[5px] transition duration-200 flex  rounded-lg justify-center items-center text-white  py-[12px] px-[5px]  ${
              ...
              <div className="gap-6 justify-between max-w-[90%] flex  items-center p-[0px 2.5vw]">
                ...
                <a
                  href="#mentor"
                  className={`hover:bg-slate-700 hover:translate-x-[5px] transition duration-200 flex items-center   justify-center  rounded-lg text-white py-[12px] px-[3px]
                ${activeSection === "mentor" ? "active" : ""}`}
                  onClick={() => {
        ...
        >
          ...
          <section
            id="students"
            className="bg-white p-4 sm:p-6 md:p-[30px] mb-[20px] sm:mb-[30px] rounded-xl shadow-[var(--shadow)] relative animate-[slideIn_0.5s_ease-out_forwards]"
          >
            <h2 className="mb-[20px] sm:mb-[25px] text-[1.4rem] sm:text-[1.7rem] border-b-2 border-[var(--accent)] pb-[8px] sm:pb-[10px] flex flex-wrap items-center gap-[10px]">
              Manage Students
            </h2>

            {/* Search bar */}
            <div className="Searching flex justify-center items-center mb-[15px] sm:mb-[20px] w-full relative">
              <svg
                width="20"
                height="20"
                viewBox="0 0 24 24"
              ...
              <input
                ...
                placeholder="Search"
                className="placeholder:pl-[2.5rem] w-full border-[#D1D5DB] border-2 rounded-[6px] text-[#6B7280] p-[10px] sm:p-[12px] focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>

            {/* Students grid */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[15px] sm:gap-[20px] md:gap-[25px]">
              {students
                .filter((s) =>
                ...
                .map((student) => (
                  <div
                    key={student.id}
                    className={`bg-white p-4 sm:p-6 shadow-md hover:shadow-lg transition-all duration-300 ease-in-out transform hover:-translate-y-1 flex flex-col justify-between ${student.status} fade-in`}
                  >
                    ...
                    <p className="text-sm sm:text-base text-gray-500 mb-2">
                      Status:{" "}
                      <span
                        className={`px-3 py-1 rounded-[5px] text-[0.8rem] sm:text-[0.85rem] font-bold text-zinc-800 ${student.status}`}
                      >
                        {student.status}
                      </span>
                    </p>
                    <div className="flex flex-wrap gap-3 sm:gap-5">
                      <button
                        ...
                        className="text-white px-4 sm:px-6 py-2 rounded-md bg-[#00bda5]"
                      >
                        Approve
                      </button>
                      <button
                        ...
                        className="text-white px-4 sm:px-6 py-2 rounded-md bg-[#e74c3c]"
                      >
                        Reject
                      </button>
                    </div>
          ...
          >
            ...
            {/* Search + Add Button */}
            <div className="flex flex-wrap gap-[10px] sm:gap-[15px] mb-[20px] sm:mb-[30px]">
              {/* Search bar */}
              <div className="Searching flex justify-center items-center w-full sm:w-[70%] relative">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 24 24"
              ...
              <button
                onClick={addCompany}
                className="bg-[#00aaff] text-white px-4 sm:px-5 h-[45px] sm:h-[7vh] rounded-lg cursor-pointer text-sm sm:text-base font-medium border-0 transition duration-200 ease-in-out hover:bg-[#016ca2] hover:-translate-y-[2px] w-full sm:w-auto"
              >
                Add Company
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[15px] sm:gap-[20px] md:gap-[25px]">
              {companies.map((company) => (
                <div
                  ...
                  } p-4 sm:p-6 shadow-md hover:shadow-lg transition-all duration-300 ease-in-out transform hover:-translate-y-1 flex flex-col justify-between fade-in`}
                >
                  <h3 className="mb-2 sm:mb-3 text-lg sm:text-[1.3rem] text-gray-900 font-semibold">
                    {company.name}
                  </h3>
                  <p className="text-sm sm:text-base text-gray-500 mb-2">
                    Status:{" "}
                    <span
                      className={`px-3 py-1 rounded-[5px] text-[0.8rem] sm:text-[0.85rem] font-bold text-zinc-800 ${company.status}`}
                    >
                      {company.status}
                    </span>
                  </p>
