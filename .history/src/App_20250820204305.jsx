...
function App() {
  ...
  return (
    <div className="overflow-x-hidden  bg-gray-50">
      ...
      <div className="flex pt-16 relative min-h-full bg-amber-300 ">
        {/* Sidebar */}
        <aside
          className={`sidebar min-h-full left-0 fixed md:static z-40 bg-gray-800 text-white  md:h-[calc(100vh-4rem)] transition-all duration-300 ease-in-out ${
