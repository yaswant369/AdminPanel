      ...
      >
        {isSidebarOpen && (
          <aside
            ...
            className={`sidebar w-[10vw] z-10 bg-[#1e293b] h-[80vh] text-white p-[20px] fixed top-[55%] -translate-y-1/2 shadow-md shadow-[rgba(0, 0, 0, 0.1)]  ${
              isSidebarOpen
                ? " z-10 bg-[#1e293b] h-[80vh] text-white p-[20px] fixed top-[55%] -translate-y-1/2 shadow-md shadow-[rgba(0, 0, 0, 0.1)]"
                : "closed"
            }  `}
          >
            <img
            ...
            <nav className="w-[100%] flex flex-col justify-center">
              <div className="navIcons flex items-center gap-0.5 p-[ 0px 2.5vw]">
                <svg
                  className="w-[3vw]"
                  width="20"
                  height="20"
                ...
                <a
                  href="#students"
                  className={` flex items-center text-white p-[12px 5px] gap-10 ${
