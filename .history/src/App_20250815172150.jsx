  ...
  return (
    <div className=" overflow-x-hidden">
      ...
      >
        {isSidebarOpen && (
          <aside
            className={`bg-[#1e293b] text-white fixed top-0 left-0 h-full p-5 shadow-lg transform transition-transform duration-300 
    ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"} 
    md:translate-x-0 md:static md:w-64`}
          >
            <img
              src="http://uptoskills.com/wp-content/uploads/2023/04/hd-logo-iguru.png"
              className="mb-6 w-32 mx-auto md:mx-0"
            />
            <nav className="flex flex-col gap-4">
              {links.map((link) => (
                <a
                  ...
                  className={`flex items-center gap-3 p-2 rounded-md hover:bg-slate-700 transition 
          ${activeSection === link.id ? "bg-slate-700" : ""}`}
                >
                  <svg
                    className="w-5 h-5"
                    viewBox="0 0 24 24"
