      ...
      >
        {isSidebarOpen && (
          <aside
            ...
            className={`sidebar fixed top-[55%] -translate-y-1/2 z-10 bg-[#1e293b] h-[80vh] text-white p-[20px] shadow-md shadow-[rgba(0,0,0,0.1)] transition-all duration-300
    ${isSidebarOpen ? "w-[20vw]" : "w-0 overflow-hidden"}
  `}
          >
            {/* Sidebar content */}
          </aside>
