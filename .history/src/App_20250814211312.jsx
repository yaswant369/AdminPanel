        ...
        {isSidebarOpen && (
          ...
          >
            ...
            <nav className="w-[100%] gap-[5vh] flex flex-col justify-center items-center">
              <div className="gap-6  max-w-[90%] flex items-center p-[0px 2.5vw]">
                <svg
                  className="w-[3vw]"
                  width="20"
                  height="20"
                ...
                <a
                  href="#dashboard"
                  className={` flex justify-center  rounded-lg items-center text-white p-[12px ]  ${
              ...
              <div className=" gap-6 max-w-[90%] flex  items-center ">
                <svg
                  className="w-[3vw]"
                  width="20"
                  height="20"
                ...
                <a
                  href="#students"
                  className={` flex justify-center  rounded-lg items-center text-white p-[12px 5px]  ${
                    activeSection === "students" ? "active" : ""
                  }`}
                  onClick={() => {
              ...
              <div className="gap-6 justify-center max-w-[90%] flex  items-center p-[0px 2.5vw]">
                <svg
                  className="w-[3vw]"
                  width="20"
                  height="20"
                ...
                <a
                  href="#companies"
                  className={` flex  rounded-lg justify-center items-center text-white p-[12px 5px]  ${
              ...
              <div className="gap-6  max-w-[90%] flex  items-center p-[0px 2.5vw]">
                ...
                <a
                  href="#mentor"
                  className={`flex items-center  text-wrap justify-center  rounded-lg text-white p-[12px 5px]
            ...
            /> */}
              ...
              <div className="Searching flex justify-center items-center mb-[20px] w-[100%] relative">
                ...
                <input
                  ...
                  onChange={(e) => setSearchTerm(e.target.value)}
                  placeholder="Search"
                  className="placeholder:pl-[3vw] focus:outline-none focus:ring-2 focus:ring-blue-500 search-input border-[#D1D5DB] border-2 rounded-[6px] text-[#6B7280] p-[12px]"
                />
              </div>
