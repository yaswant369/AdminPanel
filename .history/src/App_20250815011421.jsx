...
function App() {
  ...
  return (
    <div>
      <header className="mb-[30px] fixed top-0 left-0 z-[9] text-center px-[30px] py-[20px] rounded-xl shadow-[var(--shadow)] bg-white">
        {!isSidebarOpen && (
          <div
            className="hamburger-menu hidden text-[2rem] cursor-pointer text-black z-[1001] md:block "
        ...
        <h1 className="dashAdmin text-[2rem] flex items-center gap-[10px]">
