...
function App() {
  ...
  return (
    <div>
      <header className="mb-[30px] fixed top-0 left-0 z-[9] w-screen overflow-x-hidden flex text-center px-[30px] py-[20px] rounded-xl shadow-zinc-600 bg-white">
        {!isSidebarOpen && (
          <div
            className="  text-[2rem] cursor-pointer text-black z-[1001] md:block "
