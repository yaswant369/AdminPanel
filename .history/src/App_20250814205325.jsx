            ...
            <div className="grid   [grid-template-columns:repeat(auto-fill,minmax(280px,1fr))] gap-[25px]">
              {students
                ...
                .map((student) => (
                  <div
                    key={student.id}
                    className={`bg-amber-300 mt-[70vh]  p-6 shadow-md hover:shadow-lg transition-all duration-300 ease-in-out transform hover:-translate-y-1 flex flex-col justify-between ${student.status} fade-in`}
                  >
