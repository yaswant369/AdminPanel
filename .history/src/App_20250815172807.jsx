...
function App() {
  ...
  return (
    <div className=" overflow-x-hidden">
      <header className="mb-6 fixed top-0 left-0 z-50 w-full flex items-center px-4 py-3 bg-white shadow-md rounded-none md:rounded-xl">
        ...
        <h1 className="text-lg sm:text-xl md:text-2xl flex items-center gap-2">
      ...
      >
        {isSidebarOpen && (
          ...
          >
            ...
            <nav
              className={`w-full flex flex-col gap-6 md:gap-[5vh] justify-center items-start md:items-center transition-all duration-300 
    ${isSidebarOpen ? "block" : "hidden md:flex"}`}
            >
              {[
                ...
                <div
                  key={link.id}
                  className="flex items-center gap-4 w-full md:max-w-[90%] p-2 hover:bg-slate-700 rounded-lg transition duration-200 hover:translate-x-[5px]"
                >
                  <svg
                    className="w-5 h-5 md:w-[2vw] md:h-auto text-white"
                    viewBox="0 0 24 24"
                    fill="currentColor"
                  >
                    <path d={link.icon} />
                  ...
                  <a
                    href={`#${link.id}`}
                    className={`flex-grow text-white py-2 px-1 ${
        ...
        <main
          className={`dashboard transition-all duration-300 ease-in-out flex-1 p-[20px] ${
            !isSidebarOpen ? "w-full ml-0" : "ml-[250px]" // matches your sidebar width
          }`}
        >
          <DashboardMain />
          <section
