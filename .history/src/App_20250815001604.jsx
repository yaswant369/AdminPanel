          ...
          >
            ...
            <nav className="w-[100%] gap-[5vh] flex flex-col justify-center items-center">
              ...
              <div className=" gap-6 max-w-[90%] flex justify-between  items-center ">
                ...
                <a
                  href="#students"
                  className={`hover:bg-slate-700 hover:translate-x-[5px] transition duration-200 flex justify-center  rounded-lg items-center text-white p-[12px 5px]  ${
                    activeSection === "students" ? "active" : ""
                  }`}
                  onClick={() => {
              ...
              <div className="gap-6 justify-between max-w-[90%] flex  items-center p-[0px 2.5vw]">
                ...
                <a
                  href="#companies"
                  className={`hover:bg-slate-700 hover:translate-x-[5px] transition duration-200 flex  rounded-lg justify-center items-center text-white p-[12px 5px]  ${
