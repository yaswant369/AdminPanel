        ...
        >
          ...
          <section id="companies" className="panel slide-in">
            ...
            <div className="flex gap-[15px] mb-[30px] flex-wrap">
              ...
              <button
                onClick={addCompany}
                className=" bg-[#00aaff] text-white px-5 h-[100%]  rounded-lg cursor-pointer text-base font-medium border-0 transition duration-200 ease-in-out hover:bg-[#016ca2] hover:-translate-y-[2px]"
              >
                Add Company
              </button>
            </div>
