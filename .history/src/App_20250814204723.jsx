            ...
            <div className="grid [grid-template-columns:repeat(auto-fill,minmax(280px,1fr))] gap-[25px]">
              {students
                ...
                .map((student) => (
                  ...
                  >
                    <h3 className="mb-3 text-[1.3rem] text-[#555] font-semibold">
                      {student.name}
                    </h3>
                    ...
                    <p className="text-base text-gray-500 mb-2">
                      Status:{" "}
                      <span
                        className={`status-badge px-[10px] py-[4px] rounded-[5px] text-[0.85rem] font-bold text-white ${student.status}`}
                      >
                        {student.status}
                      </span>
                    </p>
