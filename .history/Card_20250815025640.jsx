  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col text-center sm:text-left">
        <h3 className="text-sm sm:text-[0.8rem] text-[var(--text-color)] opacity-70 mb-1 uppercase tracking-wide">
          {title}
        </h3>
        <p className="text-2xl sm:text-[2.2rem] font-bold text-[var(--text-color)] mb-1 leading-none">
          {value}
        </p>
        {percentage && (
          <p
